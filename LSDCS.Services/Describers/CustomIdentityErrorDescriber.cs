...
namespace LSDCS.Service.Describers
{
    public class CustomIdentityErrorDescriber  : IdentityErrorDescriber
    {
        public override IdentityError PasswordRequiresUniqueChars(int uniqChars)
        {
            return new IdentityError { Code = "PasswordRequiresUniqueChars", Description = $"Şifrelerde En az {uniqChars}  farklı karakter içermelidir." };
        }
